        ...
        <div className="container">
          <div className="about-sections">
            <div className="about-section">
              <img src="https://cdn.builder.io/api/v1/image/assets%2Fa9cd9068cd31419ba82b48ce6c30f6b8%2F1a12b692f4c44362a08ca646415ebab8?format=webp&width=800&height=1200" alt="1314 Industries" style={{ width: '100%', height: 'auto', maxHeight: '300px', marginBottom: '20px', borderRadius: '8px', objectFit: 'cover' }} />
              <h2>Our Story</h2>
